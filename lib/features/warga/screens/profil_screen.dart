...
class ProfilScreen extends StatelessWidget {
  ...
  Widget _buildProfileHeader(dynamic user) {
    // Resolve URL foto agar 127.0.0.1 diganti IP laptop
    debugPrint('DEBUG fotoProfil raw: ${user?.fotoProfil}');

    final String? fotoUrl = (user?.fotoProfil as String?)
        ?.replaceAll('http://127.0.0.1:54321', AppConfig.supabaseUrl)
        ?.replaceAll('http://localhost:54321', AppConfig.supabaseUrl);

    debugPrint('DEBUG fotoUrl resolved: $fotoUrl');
