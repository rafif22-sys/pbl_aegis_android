...
import 'widgets/aegis_top_header.dart'; // Sesuaikan jalur jika perlu
import '../../auth/providers/auth_provider.dart';

class SupervisorDataDiriScreen extends StatelessWidget {
  const SupervisorDataDiriScreen({super.key});
          ...
          children: [
            ...
            Column(
              children: [
                ...
                const Text(
                  'Supervisor',
                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF0D47A1)),
                ),
              ],
            ),
